...
(function($){
	...
	view = {
		...
		makeDOMNodeIcon: function(html, setting, node) {
				var nameKey = setting.data.key.name, name = setting.view.nameIsHTML ? node[nameKey] : node[nameKey].replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;');
...
/*
 * JQuery zTree excheck 3.3 http://zTree.me/
 * 
 * Copyright (c) 2010 Hunter.z
 * 
 * Licensed same as jquery - MIT License
 * http://www.opensource.org/licenses/mit-license.php
 * 
 * email: hunter.z@263.net Date: 2012-07-16
 */
(function($){
...
/*
 * JQuery zTree exedit 3.3 http://zTree.me/
 * 
 * Copyright (c) 2010 Hunter.z
 * 
 * Licensed same as jquery - MIT License
